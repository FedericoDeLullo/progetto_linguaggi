...
<div class="cont">
    <div class="container">
        <a class="btn" href="catalogo_visitatore_pantaloncini.php">Pantaloncini</a>
        <a class="btn" href="catalogo_visitatore_calzettoni.php">Calzettoni</a>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#filter').on('click', function() {
                ...
                window.location.href = 'catalogo_visitatore_magliette.php?ordina=' + selectedOption;
            });
        });
    </script>
</div>
