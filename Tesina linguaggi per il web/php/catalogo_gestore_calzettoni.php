...
<div class="cont">
    <div class="container">
        <a class="btn" href="catalogo_gestore_magliette.php">Magliette</a>
...
foreach ($prodottiArray as $prodotto) {
    ...
    echo '<h1 class="nome">' . $nome . '<a title="Lascia una recensione" href="recensione_cliente_gestore.php?id_prodotto=' . $id_prodotto . '&nome=' . $nome .'&tipologia='. $tipologia .'"><span id="rev" class="material-symbols-outlined">note_stack_add</span></a><a title="Recensioni prodotto" href="lista_recensioni_gestore.php?id_prodotto=' . $id_prodotto . '&nome=' . $nome .'&tipologia='. $tipologia .'"><span id="add" class="material-symbols-outlined">reviews</span></a></h1>';
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#filter').on('click', function() {
                ...
                window.location.href = 'catalogo_gestore_calzettoni.php?ordina=' + selectedOption;
            });
        });
    </script>
</div>
