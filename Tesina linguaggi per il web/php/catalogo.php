...
<body>
    ...
    foreach ($prodottiArray as $prodotto) {
        ...
        echo '<h2 class="nome2">' . $nome . '</h2>';
        echo '<p class="des2">' . $descrizione . '</p>';
        echo '<p class="prezzo2">Prezzo: ' . $prezzo . '€</p>';
        echo '<div class="box2">';
        echo '<img class="img2" src="' . $immagine . '" alt="' . $nome . '">';
        echo '</div>';
        ...
        $(document).ready(function() {
            ...
            $('.search-button').on('click', function() {
                ...
                $('.prodotto').each(function() {
                    var titolo = $(this).find('.nome2').text().toLowerCase();
